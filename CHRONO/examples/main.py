...
from Bauchau_stiffness_matrix_assembly import assemble_global_stiffness_matrix 
from mass_matrix_assembly_for_SONATA import assemble_global_mass_matrix
...
def main():
    ...
    # Create force vector (10N downwards downward at the last node)
    force_vector = create_force_vector(-10)
    ...
    print(f"Tip vertical displacement: {tip_disp:.6f} mm")
    ...
    tip_force = 10  # Magnitude of force [N]
    L = beam_length
    I = Iyy
