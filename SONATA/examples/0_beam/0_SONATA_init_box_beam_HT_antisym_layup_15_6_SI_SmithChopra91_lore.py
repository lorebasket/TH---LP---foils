...
job_str = '0_box_beam_HT_antisym_layup_15_6_SI_SmithChopra91_lore_v2.yaml'  # note: for better meshing convergence, units specified in yaml are in 'mm' instead of 'm'
