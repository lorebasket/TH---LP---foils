...
\input{00_drafting/common/font_config.tex}
...
\input{00_drafting/common/frontpage.tex} % custom frontpage
%\retrofrontespizio
...
%\ringraziamenti
\input{00_drafting/content/acknowledgements}
...
\input{00_drafting/common/post_summary_config.tex}
...
\input{00_drafting/content/chapters}

% \paginavuota % it works even without stile=classica

\appendix
\input{00_drafting/content/appendixA}
\input{00_drafting/content/appendixB}
